...
export default function Hero() {
    ...
    return ( 
        <main className="relative overflow-hidden">
                ...
                {/* Hero */}
                <section className="mx-auto flex max-w-7xl flex-col items-center px-6 pb-12 pt-16 text-center">
                    ...
                    <p className="mt-5 max-w-2xl text-lg leading-relaxed text-purpleThird/90">
